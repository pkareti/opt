module.exports = {
    tags: ['setupwizardcellularGemalto'],
...
var tcInfo = {
    title: 'Cellular config page: Gemalto (valid)',
    description: 'Validates the contents of the Cellular config page and its functionalities with a Gemalto Sim card with getting valid connection via Set up wizard',
...
var sar = require('../../sareportable');
var tcInfo = {
    title: 'Cellular config page: Gemalto (invalid)',
    description: 'Validates the contents of the Cellular config page and its functionalities with a Gemalto Sim card with getting failed to connect via Set up wizard',
    reference: 'URMA-25, URMA-547',
    sectionName: sar.dftSectionName(__filename)
};
