...
export const cellular_countries = {
    ...
    "Belarus": [
        ...
        { "provider": "MTS", "username": "", "password": "", "APN": ["mts"] },
        {
            ...
            "username": "",
            "password": "",
            "APN": ["mms.velcom.by", "plus.velcom.by", "vmi.velcom.by", "web.velcom.by", "web1.velcom.by", "web2.velcom.by", "web3.velcom.by"]
        },
    ],
    "Belgium": [
    ...
    "Bosnia and Herzegovina": [
        { "provider": "BH Mobile", "username": "", "password": "", "APN": ["active.bhmobile.ba"] },
        {
            ...
            "username": "",
            "password": "",
            "APN": ["data1.eronet.ba", "data2.eronet.ba", "data3.eronet.ba", "data4.eronet.ba", "gprs.eronet.ba", "mms.eronet.ba", "web.eronet.ba"]
        }
    ],
    "Botswana": [
    ...
    "Hong Kong": [
        {
            ...
            "username": "",
            "password": "",
            "APN": ["ipc.three.com.hk", "imobile.three.com.hk", "mobile.lte.three.com", "mobile.three.com.hk", "mms-g.three.com.hk", "web-g.three.com.hk"]
        },
        {
    ...
    "United States": [
        ...
        { "provider": "T-Mobile", "username": "", "password": "", "APN": ["epc.tmobile.com"] },
        {
            ...
            "username": "",
            "password": "",
            "APN": [{ "text": "VZWINTERNET", "value": "none" }],
            "carrier": "verizon",
            "gobiFirmware": "1"
        }
    ],
